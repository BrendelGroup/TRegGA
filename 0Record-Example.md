...
- [x] Install TRegGA: git clone https://github.com/BrendelGroup/TRegGA
...
# SWEET13 description: Bidirectional sugar transporter
...
#5. Configure TRegGA.config. Update TRegGA_DIR.
# IMPORTANT: TRegGA_DIR inside TRegGA.config should NOT be set using $(pwd) method, as TRegGA.config are to be
# included in different makefiles located in different directory, and using $(pwd) would result in different TRegGA_DIR. 
...
#8. Link other TRegGA repository with xlink
