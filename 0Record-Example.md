...
* The CULTIVAR can be the cultivar VARNAME, as appeared in `reads/rice_line_metadata_20140521.tsv`, such as `"KOTO OURA S 5"`, or less confusingly, the cultivar UNIQUE_ID such as `"IRIS 313-10712"`.
